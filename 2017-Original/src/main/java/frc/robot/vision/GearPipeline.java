...
public class GearPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 4.58949515553289;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSL_Threshold0:
		Mat hslThresholdInput = blurOutput;
		double[] hslThresholdHue = {65, 143.13993174061434};
		double[] hslThresholdSaturation = {57.32913669064748, 218.01194539249144};
		double[] hslThresholdLuminance = {59.62230215827338, 209.30887372013652};
		...
		double filterContoursMaxHeight = 1.0E8;
		double[] filterContoursSolidity = {0, 100};
		double filterContoursMaxVertices = 1234567.0;
